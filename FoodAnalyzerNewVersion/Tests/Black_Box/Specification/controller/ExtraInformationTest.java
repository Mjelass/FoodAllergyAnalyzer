...
public class ExtraInformationTest {
    ...
    public void testChooseTopic() {
        ...
        String[] expectedOutputs = {
            ...
            +" ",
            "Allergens, which are usually harmless substances like proteins in certain foods, trigger an immune response."
            ...
            +" ",
	        "In ancient civilizations, individuals experienced adverse effects after consuming specific foods, though the understanding of these reactions remained limited."
