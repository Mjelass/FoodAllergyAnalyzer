...
public class ExtraInformationStatementTest {
	 @Test
	    void testExtraInformationInvalid() throws Exception {
	 ...
	 @Test
	    void testExtraInformation1() throws Exception {
	        ByteArrayOutputStream outputStream = new ByteArrayOutputStream();
	        System.setOut(new PrintStream(outputStream));
	        ExtraInformationController.chooseTopic(1); 
	        assertEquals("Food allergies involve an abnormal immune response to proteins in certain foods."
	 ...
	 @Test
	    void testExtraInformation2() throws Exception {
	        ByteArrayOutputStream outputStream = new ByteArrayOutputStream();
	        System.setOut(new PrintStream(outputStream));
	        ExtraInformationController.chooseTopic(2); 
	        assertEquals("Allergens, which are usually harmless substances like proteins in certain foods, trigger an immune response."
	 ...
	 @Test
	    void testExtraInformation3() throws Exception {
	        ByteArrayOutputStream outputStream = new ByteArrayOutputStream();
	        System.setOut(new PrintStream(outputStream));
	        ExtraInformationController.chooseTopic(3); 
	        assertEquals("In ancient civilizations, individuals experienced adverse effects after consuming specific foods, though the understanding of these reactions remained limited."
	 ...
	 @Test
	    void testExtraInformation4() throws Exception {
	        ByteArrayOutputStream outputStream = new ByteArrayOutputStream();
	        System.setOut(new PrintStream(outputStream));
	        ExtraInformationController.chooseTopic(4); 
	        assertEquals("Food Allergies in Numbers:"
	 ...
	 @Test
	    void testExtraInformation5() throws Exception {
	        ByteArrayOutputStream outputStream = new ByteArrayOutputStream();
	        System.setOut(new PrintStream(outputStream));
	        ExtraInformationController.chooseTopic(5); 
	        assertEquals("Famous People with Food Allergies:"
	 ...
	 @Test
	    void testExtraInformation6() throws Exception {
	        ByteArrayOutputStream outputStream = new ByteArrayOutputStream();
	        System.setOut(new PrintStream(outputStream));
	 ...
	 @Test
	    void testExtraInformation7() throws Exception {
	        ByteArrayOutputStream outputStream = new ByteArrayOutputStream();
	        System.setOut(new PrintStream(outputStream));
	        ExtraInformationController.chooseTopic(7); 
	        assertEquals("1. Identify Allergens:"
	 ...
	 @Test
	    void testExtraInformation8() throws Exception {
	        ByteArrayOutputStream outputStream = new ByteArrayOutputStream();
	        System.setOut(new PrintStream(outputStream));
	        ExtraInformationController.chooseTopic(8); 
	        assertEquals("Reacting to Allergic Reactions:"
	                +"1. Know the Signs:"
	 ...
	 @Test
	    void testExtraInformation0() throws Exception {
	        ByteArrayOutputStream outputStream = new ByteArrayOutputStream();
	        System.setOut(new PrintStream(outputStream));
