...
public class ExtraInformationController {
	...
	public static void aboutAllergies(int AllergyChosen) {
	            	switch (AllergyChosen) {
	            case 1:
	            	System.out.println("Chosen Allergy: Peanuts:"
	            	...
	            	break;
	            case 2:
	            	System.out.println("Chosen Allergy Tree Nuts:"
	            ...
	            case 3:
	            	System.out.println("Chosen Allergy: Milk"
	            	...
	            	break;
	            case 4:
	            	System.out.println("Chosen Allergy: Egg"
	            	...
	            	break;
	            case 5:
	            	System.out.println("Chosen Allergy: Wheat"
	            ...
	            case 6:
	            	System.out.println("Chosen Allergy: Soy"
	            ...
	            case 7:
	            	System.out.println("Chosen Allergy: Fish"
	            ...
	            case 8:
	            	System.out.println("Chosen Allergy: Shellfish"
	            ...
	            case 9:
	            	System.out.println("Chosen Allergy: Sesame"
	            ...
	            case 10:
	            	System.out.println("Chosen Allergy: Gluten"
	...
	public static void AllergyPrevention() { 
    	...
    	if (userChoice == 6) {
    		...
    		while(check) {
            	...
            	int aboutChoice=scanner1.nextInt();
            	if(aboutChoice > -1 && aboutChoice < 11) {
            		check = false;
            		aboutAllergies(aboutChoice);
            	}else {
            		System.out.println("Try again number 1-10 (0 if want to exit) : ");
            		chooseTopic(userChoice);
            	}
    		}
