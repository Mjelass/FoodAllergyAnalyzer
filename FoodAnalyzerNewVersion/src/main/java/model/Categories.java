...
public class Categories {
	...
	public static List<Food> getBakeryList() {//returns a list of food
	    return Bakery;
	}
	public static List<Food> getMeatList() {//returns a list of food
	    return Meat;
	}
	public static List<Food> getDrinksList(){//returns a list of food	
	    return Drinks;
	}
	public static List<Food> getFruitsAndVegetablesList(){//returns a list of food	
	    return FruitsAndVegetables;
	}
	public static List<Food> getOthersList(){//returns a list of food			
	    return Others; 
    }    
    public static List<String> getCategoriesList() {//returns a list of string
        List<String> CategoriesList = new ArrayList<>();
    	CategoriesList.add("Bakery");
	    CategoriesList.add("Meat");
	    CategoriesList.add("Drinks");
	    CategoriesList.add("FruitsAndVegetables");
	    CategoriesList.add("Others");
	    return CategoriesList;
	}
    public static List<List<Food>> getCategories2List() {//returns a list of list of foods
        List<List<Food>> CategoriesList2 = new ArrayList<>();
	    CategoriesList2.add(Bakery);
	    CategoriesList2.add(Meat);
	    CategoriesList2.add(Drinks);
	    CategoriesList2.add(FruitsAndVegetables);
	    CategoriesList2.add(Others);
